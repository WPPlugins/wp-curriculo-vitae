(function ($) {
	...
	$(document).ready(function () {
		...
		function updateText() {
			...
			//alert($(this).attr("rel"));
		 	OrigText = $(this).html();
		 	$(this).addClass("selected").html('<form ><input type="text" class="edit" value="' + OrigText + '" />&nbsp; &nbsp;</form><a href="#" class="save" rel="'+$(this).attr("rel")+'"><span class="glyphicon glyphicon-ok green" aria-hidden="true"></span></a>&nbsp; &nbsp;<a href="#" class="revert"><span class="glyphicon glyphicon-remove red" aria-hidden="true"></span></a>').unbind('click', updateText);
		}
	});
	...
	$("#black_overlay").click(function(){
		$('.wpcvf_lightbox_content').fadeOut("slow");
		$('.wpcvcontent').fadeOut("slow");
...
//		  height: [ "toggle", "swing" ],
	...
	$("select#tipo_envio").change(function () {
		//alert($("#id_area option:selected").val());
		var option = $("select#tipo_envio option:selected").val();
		
		if(option == "1"){
			$("div.smtp").fadeIn('slow');
		}else{
			$("div.smtp").fadeOut('slow');
		}
